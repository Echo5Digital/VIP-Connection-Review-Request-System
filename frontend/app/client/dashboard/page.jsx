    ...
    return (
        <div className="dash-container">
            ...
            <div className="dash-grid">
                {/* Manifests Block */}
                <Link href="/client/manifest" className="dash-card">
                ...
                {/* Drivers Block */}
                <Link href="/client/drivers" className="dash-card">
                    <div className="dash-card__header">
                        <div className="dash-card__icon-wrap">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                {/* Feedback Block */}
                <Link href="/client/feedback" className="dash-card">
                    <div className="dash-card__header">
                        <div className="dash-card__icon-wrap">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                {/* Redirects Block */}
                <Link href="/client/redirects" className="dash-card">
                    <div className="dash-card__header">
                        <div className="dash-card__icon-wrap">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                {/* Rating Block */}
                <Link href="/client/rating" className="dash-card">
                    <div className="dash-card__header">
                        <div className="dash-card__icon-wrap">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
